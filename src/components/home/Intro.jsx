...
export default function Intro() {
  ...
  const backgroundImages = [
    ...
    { path: "/images/home-background-images/background-image3.png" },
    { path: "/images/home-background-images/background-image4.png" },
  ];
      ...
      <div className="relative h-full w-full">
        ...
        <nav className="absolute z-50 md:px-10 flex justify-between items-center w-full">
          <img
            ...
            className="h-[7vh] mt-4 md:ml-0 ml-4"
          />
          ...
          {isClicked && (
            <div className="absolute top-0 left-0 z-50 w-full h-screen px-8 py-10 font-medium text-black bg-white transition-transform duration-300">
              <div className="flex w-full">
                ...
                <button
                  onClick={clickButton}
                  className="pl-36 mb-6 text-black hover:text-sky-600 flex justify-center items-center rounded-full cursor-pointer"
                >
                  <X size={27} />
                </button>
              </div>
              ...
              <div className="flex flex-col justify-center space-y-6 mt-12">
                <a
                  href=""
                  className="py-3 text-center rounded-full bg-gray-200"
                >
                  Sign Up
                </a>
                <a
                ...
                <a
                  href=""
                  className="py-3 text-center rounded-full bg-black text-white"
                >
                  Continue in app
                </a>
              </div>
        ...
        <div className="absolute bottom-32 w-full flex justify-center">
          <p
            ...
            className="font-bold text-white hover:cursor-pointer hover:scale-102 hover:text-sky-500 transform duration-150 underline text-xl"
          >
        ...
        <div className="absolute bottom-8 h-10 w-full flex justify-center items-center gap-3">
          {backgroundImages.map((_, index) => (
            <button
              key={index}
              className="w-15 h-1 block bg-white/50 overflow-hidden rounded-full"
            >
              <span
