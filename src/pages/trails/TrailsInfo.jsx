  ...
  if (notFound) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-6">
        ...
        <Link to="/trails" className="text-sky-600 underline text-lg">
          Go Back to Trails
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-slate-50 md:p-8 p-2">
      <div className="w-[95vw] mx-auto bg-white/90 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden border border-sky-200">
        {/* HEADER */}
        <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-2 md:p-6 bg-gradient-to-r from-sky-700 to-sky-500 text-white">
          ...
          <div className="flex gap-3 items-center">
            ...
            <button
              ...
              className="inline-flex text-md md:text-lg items-center gap-2 px-4 py-2 rounded-lg bg-white text-sky-700 font-semibold shadow-sm hover:scale-103 transition hover:cursor-pointer"
            >
              Get directions
          ...
          <section className="md:col-span-2 space-y-5">
            ...
            <section className="space-y-2">
              <h1 className="text-xl font-bold">
                Photos of <span className="text-sky-600"> {trail.name}</span>
              </h1>
            ...
            <div className="">
              <h2 className="text-xl font-bold mb-2">
                About this <span className="text-sky-600">Trail</span>{" "}
              </h2>
              <p className="text-slate-700 leading-relaxed text-justify">
                {trail.description ||
                  "No detailed description available for this trail."}
              </p>
            </div>
          </section>
          ...
          <aside className="space-y-4">
            <div className="rounded-xl p-4 bg-white border border-sky-200 shadow-sm">
              <h4 className="text-lg font-bold">
                Trail <span className="text-sky-600">Stats</span>{" "}
              </h4>
            ...
            <div className="rounded-xl overflow-hidden shadow-sm border border-sky-200">
              <h4 className="text-lg font-bold p-4 bg-white border-b border-sky-200">
                Location <span className="text-sky-600">Map</span>
              </h4>
